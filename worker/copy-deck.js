...
export const COPY_DECK = {
  ...
  "it": {
    ...
    "regFormBody": "Apri il link qui sotto: il modulo contiene già i tuoi dati. In fondo alla pagina c'è il pulsante «Salva come PDF o stampa» — poi basta firmarlo.",
  ...
  "pl": {
    ...
    "regFormBody": "Otwórz odsyłacz poniżej — formularz ma już wpisane Twoje dane. Na dole strony jest przycisk „Zapisz jako PDF lub wydrukuj”, potem zostaje tylko podpis.",
  ...
  "en": {
    ...
    "regFormBody": "Open the link below: the form already has your details in it. At the bottom of the page there is a “Save as PDF or print” button — then all that is left is the signature.",
  ...
  "de": {
    ...
    "regFormBody": "Öffne den Link unten: im Formular stehen deine Daten schon drin. Unten auf der Seite ist die Schaltfläche „Als PDF speichern oder drucken“ — danach fehlt nur die Unterschrift.",
  ...
  "es": {
    ...
    "regFormBody": "Abre el enlace de abajo: el formulario ya lleva tus datos. Al final de la página está el botón «Guardar como PDF o imprimir»; luego solo falta la firma.",
  ...
  "fr": {
    ...
    "regFormBody": "Ouvrez le lien ci-dessous : le formulaire contient déjà vos données. En bas de la page se trouve le bouton « Enregistrer en PDF ou imprimer » ; il ne reste ensuite que la signature.",
